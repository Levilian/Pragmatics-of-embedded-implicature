...
\newcommand{\scalarlex}[1]{
  \begin{array}[c]{r@{ \ = \ }l}
    ...
    \sem{\word{aced}}   & \set{\tuple{\world{A}, \playerb}} \\
...
\title{Embedded implicatures as pragmatic inferences under compositional lexical uncertainty%
  \thanks{All the data and code used in this paper are available at \url{https://github.com/cgpotts/pypragmods}.
    ...
    Bernhard Schwarz, and our anonymous reviewers. %
...
non-monotone environments support implicatures inferences (though these
...
that maps words and phrases to their alternative meanings, and a covert
...
\begin{figure}[t]
  \centering
  \framebox{\includegraphics[width=0.8\textwidth]{experiment-display-binary}}
