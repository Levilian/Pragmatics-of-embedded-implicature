...
\end{examples}
%
\marginnote{R1 complained about this passage but I can't find justification for his complaints.}
%
...
\marginnote{Revision to clarify where neo-Gricean assumptions enter.}
...
insights at the level of lexical uncertainty as well. Thus, it is
worth seeing whether we can improve the picture in
...
\item\label{coverstory} We are trying to train an automated
  ...
  % free-throw shooting competition between 3 players, labeled A, B, and
  % C for convenience. We'll give you a comment the system has
  % generated, and your job is to decide whether a comment is true or
  % false.
\end{examples}
...
`intermediate implicatures'.  We have made publicly available all the
data and code associated with this paper in an effort to encourage
