...
\item 
  ...
  \item Fixed-lexicon pragmatics: the predicted values are the output
    of \subeg{agents}{L}, but all the lexical items have only
...
\secref{sec:alt}; we saw in connection with \figref{fig:subjects} and
\figref{fig:subjectsALT} that there might be substantial empirical
...
The results of that assessment are in \figref{fig:crucial-items}.  The
...
\figref{fig:exp-analysis}, and it is reassuring to see them reflected
