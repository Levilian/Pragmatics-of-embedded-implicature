...
utterance $U$ with content $p$ that meets this assumption only if
certain additional conditions are met. The listener can resolve this
tension by positing that these conditions are in fact met; in many
(but not all) cases, this means inferring that the speaker actually
...
precise interpretation of lexical items that is intended in
context. \citeauthor{Bergen:Levy:Goodman:2014} show that this model
