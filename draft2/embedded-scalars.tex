...
the model shares deep affinities with the Bayesian model of Grice
...
uncertainty models similate embedded exhaustification (though without
...
has a relatively small impact on the outcomes.) This exploration does
not change our fundamental assessment of these models when it comes to
our experimental data (\secref{sec:binary:assess}).
