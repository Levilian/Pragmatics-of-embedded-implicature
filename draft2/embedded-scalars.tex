...
\marginnote{This paragraph and the next are new, as is \figref{fig:sauerland}. They are an attempt to answer some of R3's concerns about ``global'' implicature.}
...
As \figref{fig:sauerland} shows, our model suffices to achieve this
...
\figref{fig:sauerland}.)\footnote{There is one unnatural aspect of the
  simulation in \figref{fig:sauerland}: it does not allow the speaker
...
\begin{figure}[t]
  \centering
  \framebox{\includegraphics[scale=1]{fig/experiment-display-binary}}
